...
form.addEventListener("submit", function(e) {
    ...
    (0, _baseJs.getWeather)(cityNameField).then((weatherData)=>{
        (0, _weatherJs.renderWeather)(weatherData, container);
    }).catch((error)=>{
        console.error(error);
    });
});

},{"bootstrap":"h36JB","bootstrap/dist/css/bootstrap.css":"jJvnD","./api/base.js":"ffrQO","./dom/weather.js":"gj29j"}],"h36JB":[function(require,module,exports) {
/*!
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jJvnD":[function() {},{}],"ffrQO":[function(require,module,exports) {
...
function getWeather(cityName) {
    ...
    return new Promise((resolve, reject)=>{
        fetch(apiCallToGetLanLong).then((response)=>{
            if (!response.ok) throw new Error(`Error city name data for ${cityName}`);
            return response.json();
        }).then((data)=>{
            if (data.length === 0 || data.length == null) throw new Error(`City not found: ${cityName}`);
            const latitude = data[0].lat, longitude = data[0].lon;
            ...
            if (!response.ok) throw new Error(`Error fetching weather data for ${cityName}`);
            return response.json();
        }).then((weatherData)=>{
            resolve(weatherData);
        }).catch((error)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gj29j":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iNGHL","1Z4Rq"], "1Z4Rq", "parcelRequiref3a7")
